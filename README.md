...
Applied text analytics for product categorization, clustering for customer segmentation, applied the *FP-Growth* algorithm for purchasing pattern analysis, and enhanced product recommendations using network graphs, PageRank, and A*.
